...
public class ShowMaprizonHelpAction extends JosmAction {
    ...
    private static final String HELP_HTML =
            ...
            + "<li><b>Switch cameras</b> from the bar under the image: the 360 / Left / Front / "
            + "Right buttons show the same spot through another camera on the same drive, and "
            + "say so plainly when that camera has no frame there.</li>"
            + "<li><b>Brightness and contrast</b> live behind the &#9728; button in the same bar.</li>"
            + "<li><b>Any image zooms:</b> scroll to zoom in on the photo, drag to pan around it, "
            + "double-click to fit it back to the panel. The zoom is held as you walk the "
            + "sequence, so you can follow a sign from frame to frame.</li>"
            + "</ul>"
